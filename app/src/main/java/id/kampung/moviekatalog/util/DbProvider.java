package id.kampung.moviekatalog.util;
...
import id.kampung.moviekatalog.db.DbContract;
import id.kampung.moviekatalog.db.FavoriteHelper;

import static id.kampung.moviekatalog.db.DbContract.AUTHORITY;
...
public class DbProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY, DbContract.TABLE_FAVORITE, FAVORITE);
